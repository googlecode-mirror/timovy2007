<?php
    ...
    $fpdf->WriteCurriculumRow(10, 50, "R", iconv("UTF-8", "windows-1250", __("ALUMNI_MYPROFILE_CV_NAME_AND_SURNAME", true)), array('Arial','', 14), array(241,241,241), 10, 140, "L", iconv("UTF-8", "windows-1250", $ws), array('Arial','B',14), array(241,241,241));
    $fpdf->Ln(1);

    $fpdf->WriteCurriculumRow(10, 50, "R", iconv("UTF-8", "windows-1250", __("ALUMNI_MYPROFILE_CV_ADDRESS", true)), array('Arial','', 14), array(241,241,241), 10, 140, "L", iconv("UTF-8", "windows-1250", $user['User']['address']), array('Arial','',14), array(241,241,241));
    $fpdf->Ln(1);
    
    if(!empty($user['User']['phone'])) {
      $fpdf->WriteCurriculumRow(10, 50, "R", iconv("UTF-8", "windows-1250", __("ALUMNI_MYPROFILE_CV_TELEPHONE", true)), array('Arial','', 14), array(241,241,241), 10, 140, "L", iconv("UTF-8", "windows-1250", $user['User']['phone']), array('Arial','',14), array(241,241,241));
      $fpdf->Ln(1);
    }
    
    if(!empty($user['User']['email'])) {
      $fpdf->WriteCurriculumRow(10, 50, "R", iconv("UTF-8", "windows-1250", __("ALUMNI_MYPROFILE_CV_EMAIL", true)), array('Arial','', 14), array(241,241,241), 10, 140, "L", iconv("UTF-8", "windows-1250", $user['User']['email']), array('Arial','',14), array(241,241,241));
      $fpdf->Ln(1);
    }
